                  ...
                  <div class="card-body">
                    ...
                    <p class="mb-0 mt-3 text-muted">
                      <span class="text-success"
                        >1.23 % <i class="mdi mdi-trending-up mr-1"></i
                      ></span>
              ...
              <div class="col-sm-6 col-xl-3">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="mb-0 mt-3 text-muted">
                      <span class="text-success"
                        >2.73 % <i class="mdi mdi-trending-up mr-1"></i
                      ></span>
                      From previous period
                    </p>
                  </div>
                  ...
                  <div class="card-body">
                    ...
                    <p class="mb-0 mt-3 text-muted">
                      <span class="text-danger"
                        >4.35 % <i class="mdi mdi-trending-down mr-1"></i
                      ></span>
                      From previous period
                    </p>
                  </div>
              ...
              <div class="col-sm-6 col-xl-3">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="mb-0 mt-3 text-muted">
                      <span class="text-success"
                        >7.21 % <i class="mdi mdi-trending-up mr-1"></i
                      ></span>
                      From previous period
                    </p>
                  </div>
